                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <form action="barang_res.php" method="POST">

                                <div class="form-group">
                                    <label>Id Barang</label>
                                    <input type="text" class="form-control" value ="<?php echo $auto_kode?>" name="kd_brg" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Harga </label>
                                        <input type="text" class="form-control"  name="hrg"  placeholder="Harga Jual" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-primary">
                                                     <a title="Lihat Inventory Card" href=card.php?kd_brg=<?php echo $data['kd_brg']; ?>>Lihat</a>
                                                </td>
                                                <td>
                                                 <ul class="bt-list">
                                              <li><a href=barang_hps.php?kd_brg=<?php echo $data['kd_brg']; ?> class="hvr-icon-fade col-7">Hapus</a></li>
                                                </ul>
                                            </td>
                                            <td>
                                                 <ul class="bt-list">
